...
public class Chessboard {
	...
	// 定义三维数组存放棋盘的权值信息(为了同一位置记录下权值和棋子颜色)
	private String[][][] chessBoardWeight;

	// 初始化三维数组
	public void initChessBoardWeight() {
		// 初始化棋盘数组
		chessBoardWeight = new String[BOARD_SIZE][BOARD_SIZE][2];
	...
	public void setBoard(int posX, int posY, String chessman) {
		lastX = posX;
		lastY = posY;
		this.chessBoardWeight[posX][posY][1] = chessman;
	...
	public String[][][] getWeightBoard() {
		return this.chessBoardWeight;
	}
}